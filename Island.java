...
public class Island2{
   ...
   public String jungleHike(){ 
	   ...
	   String[] guessingWords = new String[10];
		   guessingWords[0] = "s_n_";
   	   guessingWords[1] = "sand";
    	   guessingWords[2] = "_m_re_la";
	    	guessingWords[3] = "umbrella";
	    	guessingWords[4] = "pa_ay_";
	    	guessingWords[5] = "papaya";
	      guessingWords[6] = "tr_e";
	      guessingWords[7] = "tree";
	    	guessingWords[8] = "b_a_h";
	      guessingWords[9] = "beach";
         ...
         if (x == 0){ 
	         wordToGuess = guessingWords[1];
	      }
	      if (x == 2){ 
            wordToGuess = guessingWords[3];
	      }
	      if (x == 4){ 
	         wordToGuess = guessingWords[5];
	      }
	      if (x == 6){ 
	         wordToGuess = guessingWords[7];
	      }
	      if (x == 8){ 
	         wordToGuess = guessingWords[9];
	      }
